...
func TestGrid2_TurnOn(t *testing.T) {
	// arrange
	g := NewGrid1(10, 10)
...
func TestGrid2_TurnOff(t *testing.T) {
	// arrange
	g := NewGrid1(10, 10)
	for i := range g {
		for j := range g[i] {
...
func TestGrid2_Toggle(t *testing.T) {
	// arrange
...
func TestGrid2_CountLitLights(t *testing.T) {
	// arrange
...
func TestGrid2_DoForRange(t *testing.T) {
	// arrange
	g := NewGrid1(10, 10)
